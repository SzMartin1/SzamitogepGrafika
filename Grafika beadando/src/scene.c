...
void load_models_init_scene(Scene *scene) {
    ...
    load_model(&(scene->house), "assets/models/house2.obj");
...
void load_objects(Scene scene) {
    ...
    glTranslatef(scene.objectPos, 4.06f, 0.0f);
    ...
    glTranslatef(scene.objectPos, -1.0f, 0.0f);
